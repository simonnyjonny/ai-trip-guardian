...
export const createTripInputSchema = z.object({
  ...
  travelerType: z.enum(["solo", "couple", "friends", "family", "with_children", "with_parents", "business", "other"]).optional().default("solo"),
  pace: z.enum(["relaxed", "normal", "packed"]).optional().default("normal"),
  languageLevel: z.enum(["strong", "medium", "weak"]).optional().default("medium"),
  tripRegion: z.enum(["domestic", "outbound", "auto"]).optional().default("auto"),
  primaryTransport: z.enum(["flight", "train", "self_drive", "public_transport", "taxi", "mixed", "unknown"]).optional().default("unknown"),
  specialNeeds: z.array(z.string()).optional().default([]),
  inputMode: z.enum(["itinerary", "wish"]).optional().default("wish"),
